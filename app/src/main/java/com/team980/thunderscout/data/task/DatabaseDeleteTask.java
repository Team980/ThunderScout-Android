...
public class DatabaseDeleteTask extends AsyncTask<Void, Integer, Void> {
    ...
    public DatabaseDeleteTask(LocalDataAdapter adapter, Context context, List<ScoutData> datas) {
        viewAdapter = adapter;
